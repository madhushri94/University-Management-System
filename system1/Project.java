...
public class Project extends JFrame implements ActionListener {
    ...
    Project() {
        ...
        JMenuItem feereceipt = new JMenuItem("Fee Receipt");
        feereceipt.addActionListener(this);
        fee.add(feereceipt);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        } else if (msg.equals("Fee Receipt")) {
            JOptionPane.showMessageDialog(this, 
                "Fee Receipt will open after fee payment from Student Fee Form");
